...
@Component({
  selector: 'app-thu-ngo-page',
  templateUrl: './thu-ngo-page.component.html',
  styleUrls: ['./thu-ngo-page.component.scss'],
})
export class ThuNgoPageComponent {
  ...
  chiTiet: IChiTietBaiViet = {
    id: 0,
    tieuDe: 'Thư ngỏ của Lãnh đạo Trường',

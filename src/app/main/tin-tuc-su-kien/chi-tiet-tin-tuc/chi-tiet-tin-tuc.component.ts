...
export class ChiTietTinTucComponent {
  ...
  tinTucLienQuanTitle = this.langCode === 'vi' ? 'Tin tức liên quan'
    : 'Related News';

  tinTucXemNhieuNhatTitle = this.langCode === 'vi' ? 'Tin tức xem nhiều nhất' : 'Most watched news';
  tinTucTitle = this.langCode === 'vi' ? 'Tin tức' : 'News';
  ...
  tinTucss: IThongBaoSuKienTinTuc[] = [
    {
  ...
  tinTucLienQuans: IThongBaoSuKienTinTuc[] = [
    {
      anhBia: 'https://via.placeholder.com/160x90',
      tieuDe: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standa'
        + 'rd dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book',

...
import { ListSuKienComponent } from './list-su-kien/list-su-kien.component';
import { FormSuKienComponent } from './form-su-kien/form-su-kien.component';
...
export const routes: Routes = [
  { path: '', component: ListSuKienComponent },
];

...
import { FormCuuSinhVienComponent } from './form-cuu-sinh-vien/form-cuu-sinh-vien.component';
import { ListCuuSinhVienComponent } from './list-cuu-sinh-vien/list-cuu-sinh-vien.component';
...
export const routes: Routes = [
  { path: '', component: ListCuuSinhVienComponent },
];

@NgModule({
  declarations: [
    // Component here
    FormCuuSinhVienComponent,
    ListCuuSinhVienComponent,
  ],
  imports: [
    CommonModule,
    FormsModule,
...
export class CuuSinhVienModule { }

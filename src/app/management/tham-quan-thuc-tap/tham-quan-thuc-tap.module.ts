...
import { ListThamQuanThucTapComponent } from './list-tham-quan-thuc-tap/list-tham-quan-thuc-tap.component';
import { FormThamQuanThucTapComponent } from './form-tham-quan-thuc-tap/form-tham-quan-thuc-tap.component';
...
export const routes: Routes = [
  { path: '', component: ListThamQuanThucTapComponent },
];

@NgModule({
  declarations: [
    ListThamQuanThucTapComponent,
    FormThamQuanThucTapComponent,
  ],
  imports: [
    CommonModule,
    FormsModule,
...
export class ThamQuanThucTapModule {}
